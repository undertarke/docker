...
import { BASE_URL, uploadClound } from "../utils/fetchFromAPI";
  ...
  return <div className="p-5" style={{ minHeight: "95vh" }}>
    ...
    <div className="tab-content mt-3" id="nav-tabContent">
      ...
      <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabIndex={0}>
        <div className="row">
          <div className="col-2">
            <img className="rounded-circle" src={BASE_URL+"/public/img/123121512_thor.jpeg"} width="100%" />

            <input className="form-control" type="file" id="formFile" onChange={() => {
              let image = document.querySelector("#formFile").files[0]

              let formData = new FormData();
              formData.append("upload_preset","k5hbyi5n")
              formData.append("file",image)

              // tất cả các api upload đều nhận vào định dạng request là formData
              uploadClound(formData).then(result => {
                console.log(result)
