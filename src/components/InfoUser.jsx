...
import { fetchFromAPI, updateInfo, uploadAvatarApi } from "../utils/fetchFromAPI";
          ...
          <div className="col-2">
            ...
            id="formFile"
              onChange={(event) => {
                ...
                uploadAvatarApi(formData).then(filename => {
                  setAvatar(DOMAIN_BE_IMG + filename)
                }).catch()
            ...
            <form className="row g-3 text-white">
              ...
              <div className="col-12">
                <button type="button" className="btn btn-primary"
                  onClick={() => {
                    let full_name = document.querySelector("#inputFullName").value;
                    let email = document.querySelector("#inputEmail").value;
                    let pass_word = document.querySelector("#inputPassword").value;

                    updateInfo({ full_name, email, pass_word }).then(result => alert(result)).catch(err => console.log(err))
